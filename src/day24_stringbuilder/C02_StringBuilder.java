...
public class C02_StringBuilder {
    public static void main(String[] args) {
        ...
        System.out.println(sb.capacity()); // 20(capacity(16)+java(length)
        ...
        System.out.println(sb.toString().toUpperCase()); // JAVA(toString=Stringe cevirir)
        ...
        sb.insert(1,"H ");// girdigimiz indexe istedigimiz harfi ekler
        ...
        System.out.println(sb.indexOf("A", 3)); // 4 buldugu ilk Anin 3.indexten sonraki indexini verir
