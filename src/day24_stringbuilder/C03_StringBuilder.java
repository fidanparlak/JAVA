...
public class C03_StringBuilder {
    public static void main(String[] args) {
        ...
        System.out.println(sb1.compareTo(sb2)); // 0 (esitligi sorgulamak icin compareTo yapariz)0 sa deger esit demektir.
        ...
        // System.out.println(sb1==str); // data turleri farkli oldugu icin eslestirme yapmaz CTE verir

        System.out.println(sb1.equals(str)); // false
        // System.out.println(sb1.compareTo(str));
        // compareTo Sitring Builder'lar arasinda calisir, farkli data turu kabul etmez
    }
}
